function normalize_files(rows_training, rows_test)
    out1 = matfile('rot_var/TRAINING_norma.mat', 'Writable', true);
    out2 = matfile('rot_var/TEST_norma.mat', 'Writable', true);

    in1 = matfile('rot_var/TRAINING.mat');
    in2 = matfile('rot_var/TEST.mat');
